    ...
    <div className="col-12 col-sm-12 col-md-12 col-lg-6	col-xl-4 col-xxl-4">
      <ResponsiveContainer width="100%" height="100%" className="bg-gray-light">
        <PieChart>
          ...
          <Pie data={scoreData} cx="50%" cy="50%" startAngle={90} endAngle={500} innerRadius={65} outerRadius={75} paddingAngle={5} cornerRadius={50} dataKey="value" />
          <Legend layout="horizontal" align="center" verticalAlign="middle" content={<CustomLegend payload={null} />} />
        </PieChart>
      </ResponsiveContainer>
    </div>
  );
